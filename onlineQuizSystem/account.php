...
include_once 'dbConnection.php';
echo '<span class="pull-right top title1"><span style="color:white"><img src="image/profileIcon.png" style="width:30px;"> &nbsp;&nbsp;&nbsp;&nbsp;<b>Hello ,</b></span> <span class=" " style="color:white; font-size:20px; margin-right:50px;">' . $name . '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php?q=account.php" style="color:white; font-size:25px; "><img src="image/logInIcon3.png" alt="" style="width: 30px; height: 35px;">&nbsp;&nbsp;Logout</button></a></span>';
}
?>
</div>
</div></div>
...
<nav class="navbar navbar-default title1" >
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#" style="position:relative;right:700px;"><b>Netcamp</b></a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?> ><a href="account.php?q=1" style="position:relative;right:700px;"><span class="glyphicon glyphicon-home" aria-hidden="true" ></span>&nbsp;Home<span class="sr-only">(current)</span></a></li>
        <li <?php if(@$_GET['q']==2) echo'class="active"'; ?>><a href="account.php?q=2" style="position:relative;right:700px;"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;History</a></li>
		<li <?php if(@$_GET['q']==3) echo'class="active"'; ?>><a href="account.php?q=3" style="position:relative;right:700px;"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Ranking</a></li></ul>
      </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
...
<!--Footer start-->
<!--Footer start-->
<div class="row footer1" style="position:absolute; bottom:66px; width:110vw;">
